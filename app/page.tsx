...
export default function HomePage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative flex min-h-[400px] flex-col overflow-hidden md:flex-row md:min-h-[500px] lg:min-h-[600px]">
        {/* Left column — Logo + Join Now */}
        <div className="flex w-full flex-col items-center justify-center bg-gradient-to-br from-h4h-cyan to-h4h-cyan-dark px-8 py-16 md:w-1/4 md:py-0">
          <Image
