...
export default function HomePage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative min-h-[300px] overflow-hidden md:min-h-[500px] lg:min-h-[600px]">
        {/* Mobile: cyan gradient background */}
        <div className="absolute inset-0 bg-gradient-to-br from-h4h-cyan to-h4h-cyan-dark md:hidden" />
        ...
        {/* Desktop: clipped cyan overlay panel */}
        <div
          className="hidden md:block absolute inset-0 z-10 bg-gradient-to-br from-h4h-cyan to-h4h-cyan-dark"
          style={{
            clipPath: "polygon(0 0, 30% 0, 38% 50%, 30% 100%, 0 100%)",
          }}
        />

        {/* Content */}
        <div className="relative z-20 flex min-h-[300px] items-center justify-center px-8 py-16 md:min-h-[500px] md:justify-start md:pl-12 lg:min-h-[600px] lg:pl-20">
          <div className="flex flex-col items-center md:w-[28%] md:items-center">
            <Image
